...
public class TestFiguras {
    public static void main(String[] args) {
        ...
        listaFiguras.add(new Rombo(2,30));
        listaFiguras.add(new Rectangulo(2,3));
        listaFiguras.add(new Romboide(2,3,30));
    ...
    private static void mostrarFigurasYAreas(List<Figura> listaFiguras) {
        for (Figura figura: listaFiguras) {
            ...
            if (figura instanceof TrapecioIsosceles)
                System.out.printf("Área %.2f%n",((TrapecioIsosceles) figura).calcularArea() );
        }
    }
    ...
    private static void mostrarFiguras(List<Figura> listaFiguras) {
        listaFiguras.forEach( figura -> System.out.println(figura));
    }
}
