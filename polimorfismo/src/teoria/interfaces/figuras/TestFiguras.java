    ...
    public static void main(String[] args) {
     ...
     //   listaFiguras.add(new Figura(NombreFigura.TRIANGULO));
       ...
       // listaFiguras.forEach(System.out::println);
        ...
        System.out.println("-----------------------------------");
        mostrarCSV(listaFiguras);
        System.out.println("-----------------------------------");
        mostrarFigurasMayorArea(listaFiguras);
    }

    private static void mostrarFigurasMayorArea(List<Figura> listaFiguras) {
        System.out.println(Figura.devolverFiguarMayorArea(listaFiguras));
    }

    private static void mostrarCSV(List<Figura> listaFiguras) {
        for (Figura figura: listaFiguras) {
            System.out.println(figura.devolverDatosParaCSV());
        }
    }
